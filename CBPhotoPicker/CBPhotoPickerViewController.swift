...
public class CBPhotoPickerViewController: UIViewController {
    ...
    */
    public override func loadView() {
        ...
        photoCollectionView = UICollectionView(frame: CGRectMake(0, previewImageHeight, originalFrame.width, originalFrame.height-previewImageHeight-originalFrame.origin.y), collectionViewLayout: photoCollectionViewFlowLayout ?? UICollectionViewFlowLayout())
